...
public class Bill{
	...
	public String readItems()
	{
		...
		try { 
			...
			while (rs.next())
			{ 
				String billID = Integer.toString(rs.getInt("itemID"));
	...
	public String insertItem(String billID , String customerCode,String customerName, String month ,String units) {
		String output = "";
		try {
			Connection con = connect();
			if (con == null) {
	...
	String query = " insert into items (`billID`,`customerCode`,`customerName`,`month`,`units`)"  + " values (?, ?, ?, ?, ?)";
